...
class WaterSourceFormScreen extends StatefulWidget {
  const WaterSourceFormScreen({Key? key}) : super(key: key);

  @override
  State<WaterSourceFormScreen> createState() => _WaterSourceFormScreen();
}

class _WaterSourceFormScreen extends State<WaterSourceFormScreen> {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          title: const Text('Water Sources Information'),
          centerTitle: true,
